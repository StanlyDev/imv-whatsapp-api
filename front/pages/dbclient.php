...
<head>
  ...
  <script defer src="/back/js/dltDB.js"></script>
  <link rel="stylesheet" href="/front/css/dbclient.css">
  <link rel="stylesheet" href="/front/css/popupTable.css">
</head>
              ...
              if (empty($tablas)) {
                  ...
                  foreach ($tablas as $tabla) {
                      ...
                      echo "<tr class='table-row'>
                            ...
                            <td>{$numRegistros}</td>
                            <td class='text-right'>
                              <button class='icon view-button'>👁️</button>
                              <button class='icon'>✏️</button>
                              <button class='icon delete-button' data-tabla='{$tabla}'>🗑️</button>
                            </td>
                          </tr>";
                  }
              }
    ...
    <div id="popup" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-gray-800 rounded-lg p-6 w-3/4 max-h-[80vh] overflow-y-auto">
            <div class="flex justify-between items-center">
                ...
                <button id="closePopup" class="text-red-500 hover:text-red-700 text-2xl font-bold">&times;</button>
            </div>
